...
import sila2_basic_pb2 as sila2__basic__pb2
...
class SiLA2DeviceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDeviceInfo = channel.unary_unary(
                ...
                request_serializer=sila2__basic__pb2.DeviceInfoRequest.SerializeToString,
                response_deserializer=sila2__basic__pb2.DeviceInfoResponse.FromString,
                )
...
def add_SiLA2DeviceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetDeviceInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=sila2__basic__pb2.DeviceInfoRequest.FromString,
                    response_serializer=sila2__basic__pb2.DeviceInfoResponse.SerializeToString,
            ),
...
class SiLA2Device(object):
    ...
    def GetDeviceInfo(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/sila2.SiLA2Device/GetDeviceInfo',
            sila2__basic__pb2.DeviceInfoRequest.SerializeToString,
            sila2__basic__pb2.DeviceInfoResponse.FromString,
