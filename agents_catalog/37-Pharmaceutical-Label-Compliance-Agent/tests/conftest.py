...
# Add project root to path so agent_package and lambda_functions are importable
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.insert(0, PROJECT_ROOT)
sys.path.insert(0, os.path.join(PROJECT_ROOT, "agent_package"))
sys.path.insert(0, os.path.join(PROJECT_ROOT, "lambda_functions", "trigger"))
sys.path.insert(0, os.path.join(PROJECT_ROOT, "lambda_functions", "frontend_api"))
sys.path.insert(0, os.path.join(PROJECT_ROOT, "lambda_functions", "document_management"))
...
def mock_env_vars(monkeypatch):
    ...
    monkeypatch.setenv("FRONTEND_BUCKET", "pharmalabel-frontend-test")
    monkeypatch.setenv("KB_BUCKET", "pharmalabel-kb-test")
    ...
    monkeypatch.setenv("AGENT_ARN", "arn:aws:bedrock-agentcore:us-east-1:123456789:runtime/test-runtime")
