...
class TestDocumentLifecycle:
    def _setup_aws(self):
        ...
        s3.create_bucket(Bucket="pharmalabel-kb-test")
        # Seed with some documents
        s3.put_object(Bucket="pharmalabel-kb-test", Key="US_FDA/existing_doc.pdf", Body=b"fake pdf")
        s3.put_object(Bucket="pharmalabel-kb-test", Key="UK_MHRA/mhra_doc.pdf", Body=b"fake pdf 2")
        return s3
