...
# Phase 3 API Gateway URL - from environment variable or default
GATEWAY_API_URL = os.environ.get('API_GATEWAY_URL', 'https://el54g8inya.execute-api.us-west-2.amazonaws.com/dev')
logger.info(f"Using API Gateway URL: {GATEWAY_API_URL}")

if not GATEWAY_API_URL:
    GATEWAY_API_URL = 'https://el54g8inya.execute-api.us-west-2.amazonaws.com/dev'
    logger.warning(f"No API_GATEWAY_URL environment variable found, using default: {GATEWAY_API_URL}")
